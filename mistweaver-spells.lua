...
vivify:Callback(function(spell)
    ...
    if player.buff(388519) or player.buff(325209) or player.buffStacks(388048) >= 3 then return end
    if vivify:Castable() and ((lowestHpFriend and lowestHpFriend.buff("Soothing Mist")) or ((lowestHpFriend and lowestHpFriend.buff("Soothing Mist")) and player.buff(388518) or player.buff(116680)) then
        spell:Cast(lowestHpFriend)
    end
...
lifeCocoon:Callback(function(spell)
    awful.fgroup.loop(function(friend)
        ...
        if friend.buff(642) or friend.buff(186265) or friend.buff(47536) or friend.buff(47585) or friend.buff(196555) then return end
        awful.alert({
