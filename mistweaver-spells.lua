...
enveloping:Callback(function(spell)
    ...
    awful.fgroup.loop(function(friend)
        if friend.hp < lowestHp and friend.buff("Soothing Mist") or player.buffStacks(388048) >= 1 or player.buff(388519) or player.buff(116680) then
            lowestHp = friend.hp
            lowestHpFriend = friend
        end
    end)
...
vivify:Callback(function(spell)
    ...
    if vivify:Castable() and lowestHpFriend and lowestHpFriend.buff("Soothing Mist") or player.buff(392883) or player.buff(388518) or player.buff(116680) then
        spell:Cast(lowestHpFriend)
    end
end)
