...
vivify:Callback(function(spell)
    ...
    if vivify:Castable() and ((lowestHpFriend and lowestHpFriend.buff("Soothing Mist")) or lowestHpFriend.buff("Soothing Mist") and player.buff(388518) or player.buff(116680)) then
        spell:Cast(lowestHpFriend)
    end
