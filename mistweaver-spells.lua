...
local kickAllTable = awful.StringTable(kickAllSpells)
local kickHealsTable = awful.StringTable(kickHealsSpells)
local cleanseTable = awful.StringTable(cleanseSpells)
