...
defensive:Slider({text = "Fortifying Brew", var = "fBrew", min = 0, max = 100, default = 40, valueType = "%", tooltip = "Fortifying Brew triggered at % HP. (Will trade on enemy Burst!)"})
defensive:Slider({text = "Transfer Juke", var = "transfer", min = 0, max = 100, default = 60, valueType = "%", tooltip = "Transfer Juke triggered on stun at % HP."})
defensive:Slider({text = "Ring of Peace", var = "ring", min = 0, max = 100, default = 40, valueType = "%", tooltip = "Ring of Peace trigger on friendly at % HP."})
