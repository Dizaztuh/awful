...
awful.Populate({
    ...
    enveloping = Spell(124682, { heal = true }),
...
enveloping:Callback(function(spell)
    ...
    if enveloping:Castable() and lowestHpFriend or lowestHpFriend.buff("Soothing Mist") and player.buffStacks(388048) >= 1 or player.buff(388519) or player.buff(116680) or player.buff(325209) then
        spell:Cast(lowestHpFriend)
    end
end)
...
vivify:Callback(function(spell)
    ...
    if vivify:Castable() and lowestHpFriend or lowestHpFriend.buff("Soothing Mist") and player.buff(388518) or player.buff(116680) or player.buff(392883) then
        spell:Cast(lowestHpFriend)
    end
end)
