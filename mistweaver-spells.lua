...
risingSunKick:Callback(function)
    -- Check if Rising Sun Kick is castable and if the last spell wasn't Rising Sun Kick.
    -- This prevents the spell from being cast twice in a row.
    ...
    -- If the last spell was Tiger Palm and Blackout Kick is castable, then cast Blackout Kick.
...
tigerPalm:Callback(function)
    -- If the last spell wasn't Tiger Palm and Tiger Palm is castable, then cast Tiger Palm.
