...
ringOfPeace:Callback(function(spell)
    ...
    awful.friends.loop(function(friend)
        if friend.hp <= settings.ringPeace then
            awful.enemies.loop(function(enemy)
...
fortifyingBrew:Callback(function(spell)
    ...
    if player.hp <= settings.fortBrew and not player.buff(122278) and not player.buff(122783) and not player.buff(116849) then
        awful.alert({
